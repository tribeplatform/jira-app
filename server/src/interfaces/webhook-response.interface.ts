...
import { LoadBlockResult } from './block.interface'
...
export type LoadBlockWebhookResponse =
  | FailedWebhookResponse
  | (SuccessWebhookResponse & {
      type: WebhookType.LoadBlock | WebhookType.Callback
      data: LoadBlockResult & BaseSuccessWebhookResponse
    })
